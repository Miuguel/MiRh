...
def render_scene():
    ...
    ax.set_ylabel('Y')
    ax.set_zlabel('Z')
    ax.set_title(f"Cena 3D Estática - Borboleta em Cima do Toro\nArraste o mouse para rotacionar")
...
print("=== CENA 3D ESTÁTICA - BORBOLETA EM CIMA DO TORO ===")
...
2. BORBOLETA 3D:
   ...
   - Posicionamento relativo para criar oclusão

3. ALGORITMO DO PINTOR (Seção 5.3.3.1):
...
5. CONCEITOS DE CG APLICADOS:
   ...
   - Algoritmo de ordenação para oclusão
